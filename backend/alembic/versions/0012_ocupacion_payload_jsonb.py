"""Ocupación: persistir payload JSON exacto del endpoint

Revision ID: 0012_ocupacion_payload
Revises: 0011_ocupacion_horario
...
revision = "0012_ocupacion_payload"
down_revision = "0011_ocupacion_horario"
branch_labels = None
depends_on = None


def upgrade() -> None:
    # Snapshot wipe+reload: recrear tabla con JSONB fiel al endpoint.
