...
- [x] 3.2 Correr tests backend del área (`tests/test_agenda_ocupacion.py`)
- [x] 3.3 Cierre SDD 2026-08-06: ARCHIVE.md (UI superseded) + merge API a spec estable + archive folder
