...
|---------|------|-------------------|
| `novedades/` | `spec.md` | `2026-07-29-novedades-modulos` + `2026-07-29-novedades-jefe-profesionales-fecha-carga` + `2026-07-30-novedades-sincro-profesionales` (+ capital humano / bonos según archives posteriores) + `2026-08-16-novedades-tiene-produccion` + `2026-08-16-novedades-modulos-edicion` |
